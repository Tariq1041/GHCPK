<%@ Page Language="C#" AutoEventWireup="true" CodeFile="News_Page.aspx.cs" Inherits="News_Page" %>
            ...
            <div class="row">
                ...
                <div class="col-md-4 header-right">
                    <ul class="small-links login_width pull-right">
                        <li><a class="login_color" href="#"><div class="login_icon"></div>Login</a></li>
                    </ul>
                </div> <!-- /.header-right -->
            </div>
        </div> <!-- /.container -->
                                ...
                                <div class="blog-list-post clearfix">
                                  ...
                                  <tr>
                                    ...
                                    <div class="blog-list-thumb">
                                        <a href="News.aspx" runat="server"><img src="<%# Eval("News_Image")%>"  alt="" /> </a>
                                    </div>
