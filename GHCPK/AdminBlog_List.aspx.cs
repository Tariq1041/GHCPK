...
public partial class AdminBlog_List : System.Web.UI.Page
{
    ...
    private DataSet ReadXmlComments()
    {
        ...
        else
        {
            ...
            theTable.Columns.Add("Country", Type.GetType("System.String"));
    ...
    void RebuildTableView(DataSet ds)
    {
        ...
        foreach (DataRow dr in ds.Tables[0].Rows)
        {
            ...
            // tr.Cells[1].Text=String.Format("<a href="BlogEntry.aspx;"> </a>");
            this.BlogTable.Rows.Add(tr);
            ...
            tr.Cells[0].Width = 550;
            tr.Cells[0].ColumnSpan = 2;
            tr.Cells[0].Text = "Country : " + dr[3].ToString();
            this.BlogTable.Rows.Add(tr);
    ...
    {
        Response.Redirect("Blogs_Description.aspx");
    }
