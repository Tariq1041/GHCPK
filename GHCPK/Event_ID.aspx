<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Event_ID.aspx.cs" Inherits="Event_ID" %>
                            ...
                            <div class="widget-inner">
                                ...
                                <div class="event-small-list clearfix">
                                    <div class="calendar-small">
                                        <span id="Span1" class="s-month" runat="server"><asp:Label ID="lbl_month" runat="server"></asp:Label></span>
                                        <span id="Span2" class="s-date" runat="server"><asp:Label ID="lbl_date" runat="server"></asp:Label></span>
