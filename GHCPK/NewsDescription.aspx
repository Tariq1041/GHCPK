<%@ Page Title="" Language="C#" MasterPageFile="~/Front_Master.master" AutoEventWireup="true" CodeFile="NewsDescription.aspx.cs" Inherits="NewsDescription" %>
                    ...
                    <div class="list-event-item">
                            ...
                            <div class="box-content-inner clearfix">
                                ...
                                <div class="list-event-header">
                                    ...
                                    <div class="view-details"><a class="lightBtn" href="News.aspx?ID=<%#Eval("id")%>">View Details</a></div>
                                    <br />
                                    <h5 class="event-title"><p> <a href="News.aspx?ID=<%#Eval("id")%>"> <%# Eval("News_Subject")%></a></p></h5>
                                ...
                                <div class="blog-list-post clearfix">
                                  ...
                                  <tr>
                                    ...
                                    <div class="blog-list-details">
                                        ...
                                        <p class="blog-list-meta small-text"><span><a href="News.aspx"><%# Eval("Created_Date")%></a></span></p>
