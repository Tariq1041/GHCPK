<%@ Page Title="" Language="C#" MasterPageFile="~/Front_Master.master" AutoEventWireup="true" CodeFile="EventDescription.aspx.cs" Inherits="EventDescription" %>
                 ...
                 <div class="box-content-inner clearfix">               
                                ...
                                <div class="blog-list-post clearfix">
                                    ...
                                    <div class="list-event-header">
                                         <div class="view-details"><a class="lightBtn" href="Event.aspx?ID=<%#Eval("id")%>">View Details</a></div>
                                    </div>
                                </div>
                            </div>
                            </div>
