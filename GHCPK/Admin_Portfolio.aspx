<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Admin_Portfolio.aspx.cs" Inherits="Admin_Portfolio" %>
                          ...
                          <asp:ListView ID="ListView2" runat="server" >
                              <ItemTemplate>
                                   ...
                                   <%-- <div class="col-md-6 col-sm-6">--%>
                                    <div class="coll-mdd-66 col-sm-6">
                              ...
                              <ItemTemplate>
                                <div class="blog-list-post clearfix">
                                  ...
                                  <tr>
                                    ...
                                    <div class="blog-list-thumb">
                                        <a id="A1" href="AdminNews_View.aspx?" runat="server"><img src="<%# Eval("News_Image")%>"  alt="" /> </a>
                                    </div>
